...
interface MenuItem {
    href: string
    label: string
    icon: "history" | "appointment" | "prescription" | "qr"
}
...
export function PatientHeader({ menuItems }: PatientHeaderProps) {
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        <div className="text-right">
                            ...
                            <p className="text-xs text-muted-foreground">patient@demo.com</p>
                        </div>
            ...
            <aside className="hidden md:block w-64 border-r border-border bg-card min-h-[calc(100vh-73px)] fixed left-0 top-16">
                <nav className="p-4 space-y-1">
                    {menuItems.map((item) => (
                        <Link
                            key={item.href}
